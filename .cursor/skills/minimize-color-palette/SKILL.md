...
The app should have the fewest possible amount of colors and reuse them always through whole app so it would be easier to change after the pelette.

## Instructions

1. Inspect `frontend/src/styles/index.css` before introducing or changing a color.
